...
def remove_consecutive_h2(file_path):
    ...
    try:
        with open(file_path, 'r+', encoding='utf-8') as f:
            ...
            cleaned_content = re.sub(r'##\s+.*\n\s*\n*##\s+.*\n', '', cleaned_content) # Run twicetwice to catch more cases
...
if __name__ == "__main__":
    file_to_process = '/Users/encord/Git/encord-docs-mint/agents-documentation/Reference/Core/Agents-Reference-Core.md'  # Replace with the path to your file
