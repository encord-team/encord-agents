...
input_folders = {
    'Core': '/Users/encord/Git/encord-agents/encord_agents/core'
}

# Define the output markdown file path
output_file = '/Users/encord/Git/encord-docs-mint/agents-documentation/Reference/Core/Agents-Reference-Core.md'
