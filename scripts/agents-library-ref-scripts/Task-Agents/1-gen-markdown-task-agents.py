...
input_folders = {
    'Task Agents': '/Users/encord/Git/encord-agents/encord_agents/tasks',
}

# Define the output markdown file path
output_file = '/Users/encord/Git/encord-docs-mint/agents-documentation/Reference/Task-Agents/Agents-Reference-Task-Agents.md'
