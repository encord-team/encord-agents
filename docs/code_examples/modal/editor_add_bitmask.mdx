...
# 3. Configure secret [see here](https://docs.encord.com/agents-documentation/Editor-Agents/Modal#step-1-authentication).
...
See more [here](https://docs.encord.com/agents-documentation/Editor-Agents/Modal).
"""
