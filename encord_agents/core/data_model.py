...
class InstanceCrop(Frame):
    ...
    r"""
    The [ObjectInstance](https://docs.encord.com/sdk-documentation/sdk-references/objects.ontology_object_instance){ target="\_blank", rel="noopener noreferrer" } associated to the crop.
    """
